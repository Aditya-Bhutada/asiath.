...
<div class="header_listing">
	...
	<label for="Filter"><strong><?php esc_html_e( 'Filter', 'eventlist' ); ?></strong>: </label>

	<ul class="menu_tab">
		<li class="<?php echo ($listing_type == 'all' || $listing_type == '') ?  esc_attr( 'active' ) : ''; ?>">
			<a href="<?php echo add_query_arg( array( 'vendor' => 'listing', 'listing_type' => 'all' ), get_myaccount_page() ); ?>">
