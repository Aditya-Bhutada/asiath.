		...
		<div class="ova_social ova-framework-social-icons-wrapper">
			...
			<div class="content">
				...
				foreach ( $settings['social_icon_list'] as $index => $item ) {
					...
					?>
					<a class="ova-framework-icon ova-framework-social-icon ova-framework-social-icon-<?php echo $social . $class_animation; ?>" <?php echo $this->get_render_attribute_string( $link_key ); ?>>
