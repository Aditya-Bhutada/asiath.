...
<?php
global $event;
$list_gallery_large = $event->get_gallery_single_event('el_img_squa');
$list_gallery = $event->get_gallery_single_event( 'el_thumbnail' );
?>
		...
		<div class="slide_gallery">
			<div class="wrap_slide">
				...
				<?php foreach($list_gallery_large as $image) : ?>
					<div>
						<img data-lazy="<?php echo esc_attr($image); ?>" alt="<?php echo get_the_title() ?>">
					</div>
				<?php endforeach ?>
			<?php endif ?>
		</div>
