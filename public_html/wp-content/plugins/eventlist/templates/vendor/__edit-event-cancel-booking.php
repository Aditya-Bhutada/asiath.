...
$cancel_before_x_day = get_post_meta( $post_id, $_prefix.'cancel_before_x_day', true) ? get_post_meta( $post_id, $_prefix.'cancel_before_x_day', true) : apply_filters( 'el_cancel_before_x_day', 1 );
?>
...
<div class="edit_event_cancel_booking">
	...
	<input type="radio" value="yes" name="<?php echo $_prefix.'allow_cancellation_booking'; ?>" <?php if ( $allow_cancellation_booking == 'yes' ) echo esc_attr('checked') ; ?> />
	<span><?php esc_html_e( 'Yes', 'eventlist' ); ?></span>

	
	<input type="radio" value="no" name="<?php echo $_prefix.'allow_cancellation_booking'; ?>" <?php if ( $allow_cancellation_booking == 'no') echo esc_attr('checked') ; ?> />
