					...
					foreach ($args as $key => $value) {
						switch ( $args[$key] ) {
							...
							<div class="label_search wrap_search_start_date">
								<input class="el_select_date" placeholder="<?php esc_attr_e('Start date ...', 'eventlist'); ?>" name="start_date" value="<?php echo esc_attr($selected_start_date); ?>" data-format="<?php echo esc_attr( $format ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
							</div>
							<?php
							break;
							...
							<div class="label_search wrap_search_end_date">
								<input class="el_select_date" placeholder="<?php esc_attr_e('End date ...', 'eventlist'); ?>" name="end_date" value="<?php echo esc_attr($selected_end_date); ?>" data-format="<?php echo esc_attr( $format ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
							</div>
							<?php
							break;
							...
							<div class="venue label_search">
								<input class="form-control" placeholder="<?php esc_html_e('Venue ...', 'eventlist'); ?>" name="name_venue" value="<?php echo esc_attr($selected_name_venue); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
							</div>
							<?php
							break;
