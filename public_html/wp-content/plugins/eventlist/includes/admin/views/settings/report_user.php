...
if ( $range != 'custom' ) {
	...
	while ( $i > 0  ) {
		...
		// Query Booking
		$total_user_subscriber = accounting_get_total_user_registered( 'subscriber', $after, $before );
		$data_total_user_subscriber[] = accounting_get_data_total_user_registered( $after, $total_user_subscriber );

		$total_user_event_manager = accounting_get_total_user_registered( 'el_event_manager', $after, $before );
		$data_total_user_event_manager[] = accounting_get_data_total_user_registered( $after, $total_user_event_manager );
		// $total_user_registered[] = accounting_get_data_total_user_registered( $after, $total_user_subscriber, $total_user_role_event_manager );
...
if ( $range == 'custom' && $chart_interval >= 100 ) {
	...
	while ( $i >= 0  ) {
		...
		$total_user_event_manager = accounting_get_total_user_registered( 'el_event_manager', $after, $before );
		$data_total_user_event_manager[] = accounting_get_data_total_user_registered( $after, $total_user_event_manager );
		// $total_user_registered[] = accounting_get_data_total_user_registered( $after, $total_user_subscriber, $total_user_event_manager );
