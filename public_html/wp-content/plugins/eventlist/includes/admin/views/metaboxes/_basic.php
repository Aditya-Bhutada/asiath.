...
<?php if( apply_filters( 'el_show_timezone', true ) ){ ?>
	<div class="ova_row">
		...
		<input type="text" name="<?php echo esc_attr($this->get_mb_name('time_zone')); ?>" class="time_zone" id="time_zone" value="<?php echo esc_attr($this->get_mb_value('time_zone')); ?>" placeholder="<?php esc_html_e( 'UTC+1', 'eventlist' ); ?>" >
	</div>
<?php } ?>
	...
	<div id="mb_contact">
		...
		<div id="show_rewrite" style="display: none">
			<div class="ova_row">
				...
				<input type="text" id="name_organizer" class="name_organizer" value="<?php echo esc_attr($this->get_mb_value('name_organizer')); ?>" placeholder="<?php esc_attr_e( 'Name Organizer', 'eventlist' ); ?>"  name="<?php echo esc_attr($this->get_mb_name('name_organizer')); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
			</div>

			<div class="ova_row">
				<label class="label" for="phone_organizer"><strong><?php esc_html_e( 'Phone', 'eventlist' ); ?>: </strong></label>
				<input type="text" id="phone_organizer" class="phone_organizer" value="<?php echo esc_attr($this->get_mb_value('phone_organizer')) ?>" placeholder="<?php esc_attr_e( '+123 456 7890', 'eventlist' ); ?>"  name="<?php echo esc_attr($this->get_mb_name('phone_organizer')); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
			</div>

			<div class="ova_row">
				<label class="label" for="mail_organizer"><strong><?php esc_html_e( 'E-mail', 'eventlist' ); ?>: </strong></label>
				<input type="text" id="mail_organizer" class="mail_organizer" value="<?php echo esc_attr($this->get_mb_value('mail_organizer')) ?>" placeholder="<?php esc_attr_e( 'example@email.com', 'eventlist' ); ?>" name="<?php echo esc_attr($this->get_mb_name('mail_organizer')); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
			</div>

			<div class="ova_row">
				<label class="label" for="job_organizer"><strong><?php esc_html_e( 'Job', 'eventlist' ); ?>: </strong></label>
				<input type="text" id="job_organizer" class="job_organizer" value="<?php echo esc_attr($this->get_mb_value('job_organizer')) ?>" placeholder="<?php esc_attr_e( 'CEO', 'eventlist' ); ?>" name="<?php echo esc_attr($this->get_mb_name('job_organizer')); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" />
			</div>
							...
							<?php foreach ($this->get_mb_value('social_organizer') as $key => $value) { ?>
								<?php if ($value['link_social'] != ''): ?> 
									<div class="social_item">
										<input type="text" name="<?php echo esc_attr($this->get_mb_name('social_organizer['.$key.'][link_social]') ); ?>" value="<?php echo esc_attr($value['link_social']); ?>" class="link_social" placeholder="<?php echo esc_attr( 'https://' ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none">
	...
	<div id="mb_location">
		...
		<div id="mb_venue">
			<div class="ova_row">
				...
				<input type="text" name="<?php echo esc_attr( $this->get_mb_name( 'add_venue' ) ); ?>" id="add_venue" value='' autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="<?php esc_attr_e( 'White Palace', 'eventlist' ); ?>"></input>
		...
		<label>
			...
			<input type="text" value="<?php echo trim(esc_attr($this->get_mb_value( 'map_lat', $lat_default ))); ?>" name="<?php echo esc_attr($this->get_mb_name( 'map_lat' )); ?>" id="map_lat"  autocomplete="nope" autocorrect="off" autocapitalize="none"/>
		</label>

		<label>
			<?php esc_html_e( 'Longitude: ', 'eventlist' ); ?>
			<input type="text" value="<?php echo trim(esc_attr($this->get_mb_value( 'map_lng', $lng_default ))); ?>" name="<?php echo esc_attr($this->get_mb_name( 'map_lng' )); ?>" id="map_lng" autocomplete="nope" autocorrect="off" autocapitalize="none"/>
		</label>

		<input type="text" id="pac-input" name="<?php echo esc_attr($this->get_mb_name( 'map_address' )); ?>" value="<?php echo esc_attr($this->get_mb_value( 'map_address', 'New York, NY, USA' )); ?>" class="controls" placeholder="<?php esc_attr_e( 'Enter a venue', 'eventlist' ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none">
		...
		<div class="ova_row">
			<span class="edit_address">
				...
				<input type="checkbox" id="edit_full_address" class="edit_full_address" value="<?php echo esc_attr( $this->get_mb_value( 'edit_full_address', '' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'edit_full_address' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" <?php echo esc_attr( $this->get_mb_value( 'edit_full_address', '' ) ); ?> />
				<?php $edit_full_address = $this->get_mb_value( 'edit_full_address', '' ); ?>
				<input type="text" id="address" class="address" value="<?php echo esc_attr( $this->get_mb_value( 'address' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'address' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="<?php esc_attr_e( '123 Jones Street', 'eventlist' ); ?>" <?php echo esc_attr($edit_full_address != 'checked' ? 'readonly' : ''); ?> />
			</span>
		</div>

		<input type="hidden" value="<?php echo esc_attr($this->get_mb_value( 'map_name', 'New York' )); ?>" name="<?php echo esc_attr($this->get_mb_name( 'map_name' )); ?>" id="map_name"  autocomplete="nope" autocorrect="off" autocapitalize="none"/>
	</div>
</div>
