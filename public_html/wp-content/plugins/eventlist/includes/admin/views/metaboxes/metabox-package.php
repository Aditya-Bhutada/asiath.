...
<div class="ova_row">
	...
	<input type="text" id="package" class="package_id" value="<?php echo esc_attr( $this->get_mb_value( 'package_id', uniqid() ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'package_id' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="1" />
	
</div>

<div class="ova_row">

	<label class="label"><strong><?php esc_html_e( 'Register fee', 'eventlist' ); ?>: </strong></label>
	<input type="text" id="fee_register_package" class="fee_register_package" value="<?php echo esc_attr( $this->get_mb_value( 'fee_register_package', 1.5 ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'fee_register_package' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="0" />
	<span>USD</span>
...
<div class="ova_row">
	...
	<input type="number" id="package_time" class="package_time" value="<?php echo esc_attr( $this->get_mb_value( 'package_time', 30 ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'package_time' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="10" />
	<span>Day (-1 for unlimit)</span>
...
<div class="ova_row">
	...
	<input type="number" id="package_total_event" class="package_total_event" value="<?php echo esc_attr( $this->get_mb_value( 'package_total_event', 1 ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'package_total_event' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="10" />
	<span>(-1 for unlimit)</span>
...
<div class="ova_row">
	...
	<input type="text" id="fee_percent_paid_ticket" class="fee_percent_paid_ticket" value="<?php echo esc_attr( $this->get_mb_value( 'fee_percent_paid_ticket' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'fee_percent_paid_ticket' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="0.2" />
	<span>%</span>
	<strong>+</strong>
	<input type="text" id="fee_default_paid_ticket" class="fee_default_paid_ticket" value="<?php echo esc_attr( $this->get_mb_value( 'fee_default_paid_ticket' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'fee_default_paid_ticket' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="0.5" />
...
<div class="ova_row">
	...
	<input type="text" id="fee_percent_free_ticket" class="fee_percent_free_ticket" value="<?php echo esc_attr( $this->get_mb_value( 'fee_percent_free_ticket' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'fee_percent_free_ticket' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="0" />
	<span>%</span>
	<strong>+</strong>
	<input type="text" id="fee_default_free_ticket" class="fee_default_free_ticket" value="<?php echo esc_attr( $this->get_mb_value( 'fee_default_free_ticket' ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'fee_default_free_ticket' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="0" />
	<span><?php esc_html_e( 'USD', 'eventlist' ) ?></span>
...
<div class="ova_row">
	...
	<input type="text" id="order_package" class="order_package" value="<?php echo esc_attr( $this->get_mb_value( 'order_package', 1 ) ); ?>" name="<?php echo esc_attr( $this->get_mb_name( 'order_package' ) ); ?>" autocomplete="nope" autocorrect="off" autocapitalize="none" placeholder="1" />
